...
function ProjectCard({
    ...
    return (
        <div
            ...
            onKeyDown={(e) => e.key === "Enter" && navigate(`/projects/${projectId}`)}
        ...
        >
            ...
            <div className="flex items-start justify-between transition-all group-hover:scale-[1.01]">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-400">Development project</p>
                    </div>
                </div>
            ...
            {technologies && technologies.length > 0 && (
                <div className="mt-4 flex flex-wrap gap-1.5">
                    {technologies.slice(0, 3).map((technology) => (
                        <TechTag key={technology} technology={technology} />
                    ))}
                </div>
            )}

            {deadline && (
                <p className="dev-mono mt-3 text-[10px] text-slate-400">
            ...
            <div className="mt-6">
                ...
                <p className="mt-1 truncate text-sm font-medium text-gray-700">
                    {latestMilestone || "No milestone yet"}
                </p>
            </div>
            ...
            <div className="mt-6 flex items-center justify-between border-t border-gray-100 pt-4">
                <PriorityTag priority={projectPriority} />
